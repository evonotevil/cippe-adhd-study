...
platform interfaces”；其核心仍是避免操纵性界面，并在需要处提供清晰、易达的信息和操作入口。`,topic:`监管机构`,verified:`qualified`}],Ou={tomatoDuration:15,breakDuration:5,soundEnabled:!0,theme:`light`,fontSize:`medium`};function ku(){let[e,t]=(0,_.useState)(`quiz`),[n,r]=(0,_.useState)(0),[i,a]=wu(`cippe-settings`,Ou),{progress:o,stats:s,recordAnswer:c}=Eu(),l=(0,_.useMemo)(()=>yu(Du),[]),u=l[n],d=(0,_.useMemo)(()=>o.filter(e=>e.isCorrect).length/l.length,[o,l.length]),f=(0,_.useCallback)((e,t)=>{u&&c(u.id,e,t)},[u,c]),p=(0,_.useCallback)(()=>{r(e=>(e+1)%l.length)},[l.length]),m=(0,_.useCallback)(()=>{r(e=>(e+1)%l.length)},[l.length]),h={small:`text-sm`,medium:`text-base`,large:`text-lg`}[i.fontSize];return(0,H.jsxs)(`div`,{className:`min-h-screen bg-gray-50 ${h}`,children:[(0,H.jsx)(`header`,{className:`sticky top-0 z-50 bg-white shadow-sm border-b`,children:(0,H.jsxs)(`div`,{className:`max-w-4xl mx-auto px-4 py-3 flex items-center justify-between`,children:[(0,H.jsx)(`h1`,{className:`text-xl font-bold text-gray-900`,children:`CIPPE 学习终端`}),(0,H.jsxs)(`div`,{className:`text-sm text-gray-600`,children:[o.filter(e=>e.isCorrect).length,` / `,l.length,` 题`]})]})}),(0,H.jsx)(`div`,{className:`max-w-4xl mx-auto px-4 py-4`,children:(0,H.jsx)(`div`,{className:`w-full bg-gray-200 rounded-full h-2`,children:(0,H.jsx)(`div`,{className:`bg-blue-500 h-2 rounded-full transition-all duration-500`,style:{width:`${d*100}%`}})})}),(0,H.jsx)(`main`,{className:`max-w-4xl mx-auto px-4 pb-20`,children:(0,H.jsxs)(Oc,{mode:`wait`,children:[e===`quiz`&&u&&(0,H.jsxs)(fu.div,{initial:{opacity:0,x:20},animate:{opacity:1,x:0},exit:{opacity:0,x:-20},children:[(0,H.jsx)(gu,{question:u,onAnswer:f,onSkip:m,soundEnabled:i.soundEnabled}),(0,H.jsx)(`div`,{className:`mt-6 text-center`,children:(0,H.jsx)(`button`,{onClick:p,className:`px-8 py-3 bg-blue-500 text-white rounded-full font-medium hover:bg-blue-600 transition-colors`,children:`下一题 →`})})]},u.id),e===`timer`&&(0,H.jsx)(fu.div,{initial:{opacity:0},animate:{opacity:1},children:(0,H.jsx)(bu,{duration:i.tomatoDuration,breakDuration:i.breakDuration})}),e===`achievements`&&(0,H.jsx)(fu.div,{initial:{opacity:0},animate:{opacity:1},children:(0,H.jsx)(Su,{stats:s})}),e===`settings`&&(0,H.jsx)(fu.div,{initial:{opacity:0},animate:{opacity:1},children:(0,H.jsx)(Cu,{settings:i,onUpdate:a})})]})}),(0,H.jsx)(`nav`,{className:`fixed bottom-0 left-0 right-0 bg-white border-t shadow-lg`,children:(0,H.jsx)(`div`,{className:`max-w-4xl mx-auto flex justify-around py-2`,children:[{id:`quiz`,label:`刷题`,icon:`📝`},{id:`timer`,label:`番茄钟`,icon:`🍅`},{id:`achievements`,label:`成就`,icon:`🏆`},{id:`settings`,label:`设置`,icon:`⚙️`}].map(n=>(0,H.jsxs)(`button`,{onClick:()=>t(n.id),className:`flex flex-col items-center gap-1 px-4 py-2 rounded-lg transition-colors ${e===n.id?`text-blue-600 bg-blue-50`:`text-gray-500 hover:text-gray-700`}`,children:[(0,H.jsx)(`span`,{className:`text-xl`,children:n.icon}),(0,H.jsx)(`span`,{className:`text-xs`,children:n.label})]},n.id))})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,H.jsx)(_.StrictMode,{children:(0,H.jsx)(ku,{})}));